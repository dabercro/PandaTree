...
panda::Flag::Flag(char const* _name/* = ""*/) :
  Singlet(_name)
{
}

panda::Flag::Flag(Flag const& _src) :
  Singlet(_src),
...
panda::Flag&
panda::Flag::operator=(Flag const& _src)
{
  HBHENoiseFilter = _src.HBHENoiseFilter;
  HBHENoiseIsoFilter = _src.HBHENoiseIsoFilter;
  CSCTightHaloFilter = _src.CSCTightHaloFilter;
...
void
panda::Flag::doSetStatus_(TTree& _tree, utils::BranchList const& _branches)
{
...
panda::utils::BranchList
panda::Flag::doGetStatus_(TTree& _tree) const
{
  utils::BranchList blist;
...
void
panda::Flag::doSetAddress_(TTree& _tree, utils::BranchList const& _branches/* = {"*"}*/, Bool_t _setStatus/* = kTRUE*/)
{
...
void
panda::Flag::doBook_(TTree& _tree, utils::BranchList const& _branches/* = {"*"}*/)
{
...
panda::Flag::doInit_()
{
  ...
  /* BEGIN CUSTOM Flag.cc.doInit_ */
  /* END CUSTOM */
}

panda::utils::BranchList
panda::Flag::doGetBranchNames_(Bool_t _fullName) const
{
  if (_fullName)
...
void
panda::Flag::print(std::ostream& _out/* = std::cout*/, UInt_t _level/* = 1*/) const
{
  /* BEGIN CUSTOM Flag.cc.print */
  dump(_out);
  /* END CUSTOM */
}

void
panda::Flag::dump(std::ostream& _out/* = std::cout*/) const
{
